# Inlined from https://github.com/P1n3appl3/config/blob/main/mixins/home/nvim.nix
{ lib, pkgs, ... }: let
...
in {
  ...
  xdg.configFile = {
    # init.lua is managed imperatively via home.file in common.nix
    # (symlinked from dotfiles/.config/nvim/init.lua). mkForce overrides
    # home-manager's neovim module which now unconditionally enables it.
  ...
  home.packages = with pkgs; [ page lua-language-server typescript-language-server imagemagick ];
}
